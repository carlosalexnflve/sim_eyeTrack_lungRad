...
to setup
  ...
  set formula_mean_right (list (-0.00000007037505837 * ( py:runresult "dif_idx_right" / 279 ) ) (0.00004019779028 * ( py:runresult "dif_idx_right" / 279 ) ) (-0.007122360295 * ( py:runresult "dif_idx_right" / 279 ) ) (0.6072540765 * 1.5 * ( py:runresult "dif_idx_right" / 279 ) ))
  set formula_mean_left (list (-0.0000001162575198 * ( py:runresult "dif_idx_right" / 279 ) ) (0.00006145714153 * ( py:runresult "dif_idx_right" / 279 ) ) (-0.009789839553 * ( py:runresult "dif_idx_right" / 279 ) ) (0.6224039649 * 1.5 * ( py:runresult "dif_idx_right" / 279 ) ))
...
;    show sum_y
  ...
  [
    ...
    [
      ...
      let x_coord (xcor + (amax_x - round(space_max / 2)))
      let y_coord (ycor - (amax_y - round(space_max / 2)))
    ...
    [
      ...
      [
        ...
        (py:run
          ...
          let x_coord (xcor + (amax_x - round(space_max / 2))) ;multiply by 2?
          let y_coord (ycor - (amax_y - round(space_max / 2))) ;multiply by 2?
      ...
      [
          ...
          [
            ...
            [
              set color-red FALSE
              set next-pass-image (next-pass-image + (dif-pass-image * 4))
              set dif-pass-image (dif-pass-image * 5)
            ]
          ]
          [
            ifelse signal = 1
